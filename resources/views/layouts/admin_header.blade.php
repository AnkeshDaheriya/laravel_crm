...
<body>
 ...
 @if(Auth::user())
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{('index')}}#" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Crm Softwere</span>
      </a>
    ...
    <ul class="sidebar-nav " id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-folder-fill font-size"></i><span>Component</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content text-light collapse " data-bs-parent="#sidebar-nav">
         <li>
         ...
         <li>
            <a href="{{('client')}}#">
              <i class="bi bi-circle"></i><span>Client Information</span>
            </a>
          </li>
        </ul> 
         <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav4" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text font-size"></i><span>Gallery</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav4" class="nav-content text-light collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{('add-gallery')}}#">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav5" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text font-size"></i><span>Video Gallery</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav5" class="nav-content text-light collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{('add-video')}}#">
              <i class="bi bi-circle"></i>Video<span></span>
            </a>
          </li>
           <li>
  ...
  <footer  id="footer" class="footer">
    <div class="credits">  
      Designed by <a href="https://www.incubationmasters.com" target="_blank">Incubation Masters </a>
    </div>
  </footer><!-- End Footer -->
 @endif
